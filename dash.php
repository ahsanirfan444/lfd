...
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">Create User</a></li>
      </ul>
          </div>
  </div>
</nav>
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Email</b></td><td style="vertical-align:middle"><b>Cell Number</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    $c = $showfrom-1;
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $email . '</td><td style="vertical-align:middle">' . $phno . '</td><td style="vertical-align:middle">' . $gender . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle">';
        }
    }
    else{
    }
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Email</b></td><td style="vertical-align:middle"><b>Cell Number</b></td><td style="vertical-align:middle"><b>University</b></td><td style="vertical-align:middle"></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $name      = $row['name'];
        $phno      = $row['phno'];
        ...
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $gender . '</td><td style="vertical-align:middle">' . $email1 . '</td><td style="vertical-align:middle">' . $phno . '</td><td style="vertical-align:middle">' . $uni1 . '</td>
  <td style="vertical-align:middle"><a title="Delete User" href="update.php?demail=' . $email1 . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<div class="col-md-4 panel"> 
  <form class="form-horizontal" name="form" action="sign.php?q=dash.php?q=6" onSubmit="return validateForm()" method="POST">
<fieldset>
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <h3 align="center"><b>CREATE A USER</b></h3>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="email" name="email" placeholder="Enter Email ID" class="form-control input-md" type="email" value="';
if (isset($_GET['email']))
{
echo $_GET['email'];
};
...
<div class="form-group">
  <label class="col-md-12 control-label" for="uni"></label>
  <div class="col-md-12">
    <input id="uni" name="uni" placeholder="Enter University" class="form-control input-md" type="text" value="';
if (isset($_GET['uni']))
{
echo $_GET['uni'];
}
...
<div class="form-group">
  ...
  <div class="col-md-12" style="text-align: center"> 
    <input  type="submit" value="Create User " class="btn btn-primary" style="text-align:center" />
  </div>
</div>
